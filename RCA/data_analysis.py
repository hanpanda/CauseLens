...
def read_data_for_methods(dataset='TT'):
    ...
    for method in methods:
        ...
        method_df = method_df.rename(columns={'Top@1': 'HR@1', 
                                                'Top@2': 'HR@2', 
                                                'Top@3': 'HR@3', 
                                                'Top@4': 'HR@4', 
                                                'Top@5': 'HR@5', })
...
def plot_params_and_metrics(result_dir, metric_data, metric_names='', fault_types=[], param_name='alpha', figsize=None, xlabel=r'$\alpha$', ylabel=''):
...
def main():
    ...
    def tau_experiment():
        ...
        plot_params_and_metrics(image_dir, 
                                metric_data, 
...
def compute_avg():
    ...
    # ]
    array = [
        0.792, 0.896, 0.896, 0.896, 0.896, 
        0.464, 0.638, 0.739, 0.754, 0.768, 
        0.556, 0.694, 0.847, 0.903, 0.917, 
        0.600, 0.733, 0.778, 0.822, 0.844,  
    ]
...
def overhead_analysis():
    ...
    def read_traces_aiops(nrows=None):
        print('读取traces...')
        traces_dir = '../datasets/AIOps-2022/dataset/2022-03-19/cloudbed-1/trace/all/'
    ...
    print('num_spans: {}.\n'
          ...
          'data process time: {} s. {} s.'
          .format(num_spans,
                  num_spans_per_minute,
                  time_data_process,
                  time_data_process / (60 * 24)))
